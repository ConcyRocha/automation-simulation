...
$(document).ready(function(){
    ...
    $("#select_room").on("change", function(){
        ...
        if(room == "garagem"){
          $(".wrapper-room img.room").attr("src", "img/room/garagem/garagem.jpg");
        }else if(room == "sala"){
          $(".wrapper-room img.room").attr("src", "img/room/sala/sala.jpg");
        }else if(room == "quarto"){
          $(".wrapper-room img.room").attr("src", "img/room/quarto/quarto.jpg");
        }else if(room == "cozinha"){
          $(".wrapper-room img.room").attr("src", "img/room/cozinha/cozinha.jpg");
        }else if(room == "banheiro"){
          $(".wrapper-room img.room").attr("src", "img/room/banheiro/banheiro.jpg");
        }
    ...
    */
    ...
    if(flag_personagem == 1){
        ...
        if(current_room == "garagem"){
            $(".wrapper-room img.room").attr("src", "img/room/garagem/garagem"+caminhoImagem);
        }else if(current_room == "sala"){
            $(".wrapper-room img.room").attr("src", "img/room/sala/sala"+caminhoImagem);
        }else if(current_room == "quarto"){
            $(".wrapper-room img.room").attr("src", "img/room/quarto/quarto"+caminhoImagem);
        }else if(current_room == "cozinha"){
            $(".wrapper-room img.room").attr("src", "img/room/cozinha/cozinha"+caminhoImagem);
        }else if(current_room == "banheiro"){
            $(".wrapper-room img.room").attr("src", "img/room/banheiro/banheiro"+caminhoImagem);
        }
